  ...
  async analyzeGaps(signals: ExternalRecipeSignal[]): Promise<ContentOpportunity[]> {
    ...
    for (const cluster of groupedConcepts) {
      ...
      opportunities.push({
        ...
        rawCommercialScore: scoreResult.profitScore?.rawCommercialScore,
        qualityMultiplier: scoreResult.profitScore?.qualityMultiplier,
        noveltyMultiplier: scoreResult.profitScore?.noveltyMultiplier,
        finalProfitOpportunityScore: scoreResult.profitScore?.finalProfitOpportunityScore,
        profitScore: scoreResult.profitScore,
        decision: scoreResult.decision,
        whyNow: scoreResult.whyNow,
        revenueRoutes: scoreResult.revenueRoutes,
        affiliateVerification: scoreResult.profitScore?.affiliateVerification,
