...
export const TARGET_10_THEMES: CanonicalTopicDefinition[] = [
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Predicted catering fit pro finger-food a sharing bar na rauty (cateringová hypotéza servírování s rozmarýnovou focacciou; kandidát na pilot, vyžaduje reálné ověření na akci).",
  ...
  },
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Predicted catering fit jako teplý finger-food prvek (cateringová hypotéza pro rautové kornoutky či břidlici s aioli; kandidát na pilot, vyžaduje reálné ověření na akci).",
  ...
  },
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Cateringová hypotéza pro privátní brunch catering a live cooking stanice (kandidát na pilot, vyžaduje reálné ověření na akci).",
  ...
  },
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Vysoký predicted catering fit pro vegetariánské rauty (cateringová hypotéza servírování na velkých mísách; kandidát na cateringový pilot, vyžaduje reálné ověření na akci).",
  ...
  },
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Cateringová hypotéza pro uvítací recepce a firemní večírky (kandidát na pilotní zařazení do nabídky, vyžaduje reálné ověření na akci).",
  ...
  },
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Cateringová hypotéza pro teplý chod zážitkového rautu (kandidát na pilot, vyžaduje reálné ověření na akci).",
  ...
  },
  {
    ...
    briefTemplate: {
      ...
      cateringUsage: "Cateringová hypotéza pro dopolední konference a brunch catering (kandidát na pilot, vyžaduje reálné ověření na akci).",
    ...
    if (resultList.length > 0) {
      ...
      if (opp.decision === "CREATE" && item.briefTemplate) {
        opp.originalContentBrief = {
          ...
          affiliateVerification: opp.profitScore?.affiliateVerification,
