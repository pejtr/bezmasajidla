...
export const restaurants: Restaurant[] = [
  ...
  // ── BAGETERIE BOULEVARD ──
  {
    ...
    fastFoodItems: [
      { name: "Caprese bageta", description: "Čerstvá mozzarella, rajčata, bazalka, pesto. Vegetariánská.", isVegan: false, price: "129 Kč" },
      { name: "Avokádo & hummus bageta", description: "Avokádo, hummus, rukola, cherry rajčata, semínka. 100% veganská.", isVegan: true, price: "149 Kč" },
      { name: "Halloumi bageta", description: "Grilovaný halloumi, grilovaná zelenina, tzatziki. Vegetariánská.", isVegan: false, price: "139 Kč" },
      { name: "Veganský wrap", description: "Falafel, hummus, zelenina, tahini omáčka. 100% veganský.", isVegan: true, price: "119 Kč" },
    ],
  },
  // ── UGO ──
  {
    ...
    description: "Český řetězec zaměřený na zdravé stravování — fresh džusy, smoothie, saláty a teplá jídla. Většina nabídky je vegetariánská nebo veganská. Oblíbené místo pro zdravý oběd nebo svačinu. Pobočky v nákupních centrech i na ulici.",
