...
const receptyMegaMenu = {
  ...
  cuisines: [
    { href: "/recepty?q=česká", label: "Česká kuchyně" },
    { href: "/recepty?q=italská", label: "Italská" },
    { href: "/recepty?q=asijská", label: "Asijská" },
    { href: "/recepty?q=gruzínská", label: "Gruzínská" },
    { href: "/recepty?q=mexická", label: "Mexická" },
    { href: "/recepty?q=indická", label: "Indická" },
  ],
  featured: {
            ...
            <div className="md:hidden py-4 border-t border-emerald-100">
              <nav className="flex flex-col gap-1">
                ...
                <div className="px-4 pt-3 pb-1">
                  <p className="text-xs font-bold text-emerald-600 uppercase tracking-wider mb-2">Restaurace</p>
                  <div className="grid grid-cols-2 gap-1">
                    {restauraceMegaMenu.types.map((item) => (
                      <Link
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-emerald-50 text-sm text-gray-700"
                      >
                  ...
                  <Link href="/restaurace" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 px-3 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50 rounded-lg mt-1">
                    Všechny restaurace →
                  </Link>
                </div>

                {/* VEG Recepty section */}
                <div className="px-4 pt-3 pb-1 border-t border-emerald-50">
                  <p className="text-xs font-bold text-emerald-600 uppercase tracking-wider mb-2">VEG Recepty</p>
                  <div className="grid grid-cols-2 gap-1">
                  ...
                  <Link href="/recepty" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 px-3 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50 rounded-lg mt-1">
                    Všechny recepty →
                  </Link>
                </div>
                ...
                <div className="border-t border-emerald-50 pt-2">
                  {navLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className="px-4 py-3 text-sm font-medium text-gray-700 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-colors block"
                      onClick={() => setMenuOpen(false)}
                    >
                      {link.label}
                    </Link>
                ...
                {isAuthenticated && user ? (
                  <>
                    <Link href="/pridat-recept" className="px-4 py-3 text-sm font-medium text-gray-700 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-colors flex items-center gap-2" onClick={() => setMenuOpen(false)}>
                      <ChefHat className="w-4 h-4 text-emerald-600" /> Přidat recept
                    </Link>
                    {user.role === "admin" && (
                      <Link href="/admin" className="px-4 py-3 text-sm font-medium text-amber-700 hover:text-amber-800 hover:bg-amber-50 rounded-lg transition-colors flex items-center gap-2" onClick={() => setMenuOpen(false)}>
                        <Shield className="w-4 h-4" /> Administrace
                      </Link>
                    )}
